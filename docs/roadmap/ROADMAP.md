...
5. 首个存量升级版本 v1.1.0 已完成一键升级、custom-format 备份、manifest/checksum、advisory lock、失败恢复和 PostgreSQL 16 验收；创建并通过不可变 v1.1.0 Tag Release 后，继续推进多部署 Provider 真实云端 lifecycle
